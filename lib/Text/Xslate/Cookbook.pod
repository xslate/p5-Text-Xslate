...
=head2 How to cooperate with Data::Section::Simple

The C<path> option of C<new()> accepts HASH references which contain
C<< $file_name => $content >> mapping, which is compatible with
Data::Section::Simple.

    use Text::Xslate;
    use Data::Section;
    my $tx = Text::Xslate->new(
        path => [ Data::Section->new()->get_data_section() ],
    );
...
See also L<Data::Section> and L<Text::MicroTemplate::DataSection>.
