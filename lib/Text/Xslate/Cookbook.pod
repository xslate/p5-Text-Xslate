...
=head2 How to cooperate with FillInForm

Use the block filter syntax with the C<raw> filter.
...
See also L<HTML::FillInForm> or L<HTML::FillInForm::Lite>.

=head2 How to cooperate with HTML form builders

Fill the result form builders renders with the C<raw> filter.
