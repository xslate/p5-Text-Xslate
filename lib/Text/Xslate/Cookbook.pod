...
All you have to do is to apply the C<raw> filter to the result form builders
return.

Here is an example for a form builder as a PSGI application.

Code using C<HTML::Shakan>:
