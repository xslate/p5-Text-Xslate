...
Xslate::Manual::Builtin - Builtin methods and filters/functions in Xslate

=head1 DESCRIPTION

This document describes builtin methods and filters/functions in Xslate.

Note that the xslate is not aware of B<context>, so all the
...
The namespace of SCALARs is C<scalar>.
...
Reduces I<$a> by caling I<$callback> multiple times.
...
Returns an ARRAY reference consisting of the keys of I<$h>.

=head3 C<$h.values()>

Returns an ARRAY reference consisting of the values of I<$h>.

=head3 C<$h.kv()>

Returns an ARRAY reference consisting of the key-value pairs of I<$h>.
...
Escapes html meta charaters in I<str>. If I<str> is a raw string, this
...
Escapes unsafe URI characters in I<$str> as defined by RFC 3986.
...
Stringifies I<$value> with C<Data::Dumper>.
