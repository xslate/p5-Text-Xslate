...
Instead, you can create multiple instances by different attributes.
...
L<Tiffany> for general usage, including L<Amon2>
...
L<https://github.com/gfx/p5-Text-Xslate/issues>
