...
C<Text::Xlsate::PP::Opcode>, which is the default, is slow but stable.
C<Text::Xslate::PP::Booster>, which is used on
C<< $ENV{XSLATE} = 'pp=booster' >>, is fast but not stable.
